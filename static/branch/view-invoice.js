    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            function drawRow(rowData) {
                ...
                var view = '<button id="btnEdit" type="button" class="btn btn-outline-secondary" value=' + rowData["id"] + '  data-bs-toggle="modal" data-bs-target="#expadd"><i class="icofont-eye-alt text-primary"></i></button>'
